          ...
          locations.forEach(function (loc) {
            ...
            if (loc.description) {
              marker.bindTooltip(
                ...
                '<p>'
                  .concat(loc.description, '</p><p>')
                  .concat(loc.address || '', '</p>'),
                {
                  permanent: true,
 ...
 */
    ...
    'login.js': [
      ...
      { axios: '../../node_modules/axios/index.js', './alert.js': 'alert.js' },
    ],
    'updateSettings.js': [
      function (require, module, exports) {
        'use strict';
    ...
    'index.js': [
      function (require, module, exports) {
        ...
        } //So again, index.js is more for getting data from the user interface, so from the website, and then delegating some actions into these other modules,
        // DOM ELEMENTS
      ...
      },
      {
        ...
        './mapbox.js': 'mapbox.js',
        './login.js': 'login.js',
        './updateSettings.js': 'updateSettings.js',
        './stripe.js': 'stripe.js',
      },
    ],
